...
double move_forward_time = 5;  // secondsdouble move_forward_time = 5;  // seconds
double turn_time = 3;  // seconds

void move_forward() {
    ROS_INFO("Moving forward...");
    twist_msg.linear.x = 0.5;  // Set linear velocity in x direction
...
void turn() {
    ROS_INFO("Turning...");
    twist_msg.angular.z = 0.5;  // Set angular velocity about z axis
    cmd_vel_pub.publish(twist_msg);
